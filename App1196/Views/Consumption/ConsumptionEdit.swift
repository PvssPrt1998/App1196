                ...
                HStack {
                    ...
                    Button {
                        if let quantity = Int(quantity) {
                            source.edit(Consumption(uuid: uuid, quantity: quantity, name: name, date: date, term: term))
                        }
...
#Preview {
    EditConsumption(consumption: Consumption(uuid: UUID(), quantity: 15, name: "Name", date: "11.11.1111", term: "11.11.1111"))
